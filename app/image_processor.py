...
class ImageProcessor:
    ...
    def _create_manifest(self, image):
        ...
        manifest = self._manifest_factory.manifest(label="Manifest for " + mhs_number, ident=mhs_number)
    ...
    def _add_canvases(self, images, manifest):
        ...
        for p in range(len(images)):
            ...
            mhs_number = images[p]["MHS_NUMBER"]
            cvs = seq.canvas(ident=mhs_number, label="Page %s" % p)
            ...
            self._tile_generator.generate(image_file, mhs_number)
